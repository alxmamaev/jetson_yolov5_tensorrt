...
[TensorRT](https://developer.nvidia.com/tensorrt) - is a toolset, that contains model optimizer and high performance inference runtime.
...
## Run simple examples
* Pool docker container or build it (See build section):  `docker pull alxmamaev/jetson_yolov5_trt:latest` (if you not pull it yet)
